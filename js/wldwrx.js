...
function getEPieDataR03() {
	return {
		legend: {
			data: ['物业管理', '市改建设', '农民及农村问题', '城管执法', '社会治安', '卫生医疗', '民工工资及拖欠工程数',
				'城管执法1', '社会治安1', '卫生医疗1', '民工工资及拖欠工程数1'
			]
		},
		series: [{
			name: '单个部门-下拉.满意度分析 ',
...
jusfPie.drawRingPieR03('echart3', getEPieDataR03());
...
jusfPie.drawRingPieR02('echart4', getEPieDataR04());
...
jusfBar.drawHrzBarOther('echart5_2', getEBarDataOther2(), 3);

//echart6 7

var echart6data1 = {
	'id': 'echart6',
	'dq': ['坊子区', '潍城区', '奎文区', '寒亭区', '诸城区', '寿光区', '青州市', '高密市', '昌邑市', '安丘市', '昌乐市'],
